...
using MSAschools.Models;

namespace MSAschool.Data
{
    public class StudentContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
           ...
           .Build();
            ...
            // MSASchoolConnection is the name of the key that
            // contains the has the connection string as the value
            optionsBuilder.UseSqlServer(configuration.GetConnectionString("MSASchoolConnection"));
        }
    }
}
